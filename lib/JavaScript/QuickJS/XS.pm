...
JavaScript::QuickJS::XS - Perl XS binding for the QuickJS Javascript embeddable
engine
...
=head1 SYNOPSIS
    ...
    my $vm = JavaScript::QuickJS::XS->new();
    ...
    my $vm = JavaScript::QuickJS::XS->new($options);
...
This module provides an XS wrapper to call QuickJS from Perl.

The wrapper is used in an OO way: you create an instance of
C<JavaScript::QuickJS::XS> and then invoke functions on it.

=head1 METHODS/ATTRIBUTES

=head2 new

Create a new instance of C<JavaScript::QuickJS::XS>.  You can give an optional
...
=item * L<< https://metacpan.org/pod/JavaScript::QuickJS >>
...
QuickJS Javascript embeddable engine|http://duktape.org >>.
